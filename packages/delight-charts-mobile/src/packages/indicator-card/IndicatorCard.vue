...
import '@{symbol}/reds-h5-style/src/color/theme/index.styl'
import '@{symbol}/reds-h5-style/src/color/always/index.global.styl'
import '@{symbol}/reds-h5-style/src/color/light/index.global.styl'
import '@{symbol}/reds-h5-style/src/color/dark/index.global.styl'
