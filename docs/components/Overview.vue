<template>
  ...
  <Histogram class="chart-demo" :width="320" :height="300" :chartData="chartData" :dimensions="['日期']" :metrics="['余额1', '余额2', '年龄']"
             :chartConfig="hisChartStackConfig"/>
  <Pie class="chart-demo chart-pie" :width="320"  :height="300" :chartData="chartData" :dimensions="['日期']" :metrics="['余额1', '余额2', '年龄']"
       :chartConfig="pieChartConfig"/>
  <Pie class="chart-demo chart-pie" :width="320"  :height="300" :chartData="chartData" :dimensions="['日期']" :metrics="['余额1', '余额2', '年龄']"
       :chartConfig="circleChartConfig"/>
  <Circle class="chart-demo chart-pie" :width="350" :height="300" :dimensions="['日期']" :metrics="['余额1', '余额2', '年龄']" :chartData="chartData"
          :chartConfig="circleTChartConfig"/>
  </div>
